...
import { ProductFormData, ProductSize } from "@/types/product";
import {
  Select,
  SelectContent,
  SelectItem,
        ...
        <TabsContent value="images" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Add images of your product (up to 10)
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ProductImageGallery
                  ...
                  <div className="flex flex-col gap-2">
                    <label className="flex items-center gap-2">
                      <input
                        ...
                        onChange={() => { handleChange("moqMin", 1); handleChange("moqMax", 100); }}
                      />
                      1 - 100
                    </label>
                    <label className="flex items-center gap-2">
                      <input
                        ...
                        onChange={() => { handleChange("moqMin", 10); handleChange("moqMax", 1000); }}
                      />
                      10 - 1000
                    </label>
                    <label className="flex items-center gap-2">
                      <input
                        ...
                        onChange={() => { handleChange("moqMin", 100); handleChange("moqMax", 10000); }}
                      />
                      100 - 10000
                    </label>
                  </div>
        ...
        <TabsContent value="attributes" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Add additional attributes to your product
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
