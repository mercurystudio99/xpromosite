...
export interface IOrderItem {
  product: string; // Changed from mongoose.Types.ObjectId to string
  productSnapshot: {
    name: string;
    price: number;
    image: string;
...
export interface IOrder {
  orderNumber: string;
  user?: string; // Optional for guest checkout - Changed from mongoose.Types.ObjectId to string
  items: IOrderItem[];
...
// MONGODB CODE DISABLED - Schemas commented out
// // Schemas
